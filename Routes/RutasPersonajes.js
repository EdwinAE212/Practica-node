...
router.get("/", async (req, res) => { 
    try {
        ...
        const total = await PersonajeServ.Contar();
        const lista = await PersonajeServ.ListaTodos(page, limit);
        res.json({ page, limit, total, totalPages: Math.ceil(total / limit), data: lista });
